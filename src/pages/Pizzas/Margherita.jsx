...
import image from "../images/margherita.jpg"; // replace with actual Margherita image

function Margherita({ onAdd }) {
  ...
  const pizza = {
    ...
    image,
    desc:
      "Our classic Margherita Pizza features a thin, hand-stretched crust topped with rich tomato sauce, fresh mozzarella, and fragrant basil. Simple, fresh, and utterly delicious.",
    ingredients: [
      "Tomato Sauce",
      "Mozzarella Cheese",
      "Fresh Basil",
        ...
        <div className="bg-gray-50 p-4 rounded-lg shadow-sm space-y-3">
          <div>
            <p className="text-gray-700 italic">
              “Classic and fresh — the perfect pizza for any occasion.”
            </p>
          ...
          <div>
            <p className="text-gray-700 italic">
              “Loved the simplicity and flavor balance — truly authentic!”
            </p>
            <div className="text-yellow-400 flex gap-1 mt-1">
              {[...Array(4)].map((_, i) => (
                <FaStar key={i} />
